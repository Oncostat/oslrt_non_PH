...
t_cont_llogis <- rllogis(n = 3000, shape = shape_llogis, scale = scale_llogis)
delta_cont <- ifelse(t_cont<(2555/365), 1, 0)
t_cont <- ifelse(t_cont>(2555/365), (2555/365), t_cont)
t_cont_llogis <- ifelse(t_cont_llogis>(2555/365), (2555/365), t_cont_llogis)
C <- survfit(Surv(t_cont, delta_cont)~1)
C_llogis <- survfit(Surv(t_cont_llogis, delta_cont)~1)
...
lines(C_llogis, conf.int = FALSE, col = 'grey')
legend('right', .9, c("Control", "Experimental", "Log-logistic"), col = c('black','blue', 'grey'), lty = c(1,1,1))
...
lambda_cens <- 0.07  #15% of censoring 
...
for(i in 1:nit){
  ...
  data20 <- ten(S20)
  a20 <- OSLRT(data = data20, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  a202 <- mOSLRT(data = data20, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  b20 <- Score_RC(data = data20, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  c20 <- Score_DE(data = data20, CP = CP_DE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  d20 <- Score_EE(data = data20, CP = CP_EE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  e20 <- Score_ME(data = data20, CP1 = CP_ME1, CP2 = CP_ME2, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  tau20 <- max(t20)
  rmst_exp20 <- rmst_single(time = t20, status = delta20, tau = tau20)
  a <- test_SA(rmst_exp = rmst_exp20[1], se_rmst_exp = rmst_exp20[2], tau = tau20, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  g20_hoch <- maxcombo1(data = data20, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[1]
  g20_exact <- maxcombo1(data = data20, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  a20_init <- OSLRT(data = data20, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  a202_init <- mOSLRT(data = data20, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  b20_init <- Score_RC(data = data20, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  c20_init <- Score_DE(data = data20, CP = CP_DE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  d20_init <- Score_EE(data = data20, CP = CP_EE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  e20_init <- Score_ME(data = data20, CP1 = CP_ME1, CP2 = CP_ME2, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  a_init <- test_SA(rmst_exp = rmst_exp20[1], se_rmst_exp = rmst_exp20[2], tau = tau20, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  g20_hoch_init <- maxcombo1(data = data20, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[1]
  g20_exact_init <- maxcombo1(data = data20, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  
  data30 <- ten(S30)
  a30 <- OSLRT(data = data30, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  a302 <- mOSLRT(data = data30, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  b30 <- Score_RC(data = data30, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  c30 <- Score_DE(data = data30, CP = CP_DE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  d30 <- Score_EE(data = data30, CP = CP_EE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  e30 <- Score_ME(data = data30, CP1 = CP_ME1, CP2 = CP_ME2, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  tau30 <- max(t30)
  rmst_exp30 <- rmst_single(time = t30, status = delta30, tau = tau30)
  b <- test_SA(rmst_exp = rmst_exp30[1], se_rmst_exp = rmst_exp30[2], tau = tau30, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  g30_hoch <- maxcombo1(data = data30, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[1]
  g30_exact <- maxcombo1(data = data30, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  a30_init <- OSLRT(data = data30, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  a302_init <- mOSLRT(data = data30, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  b30_init <- Score_RC(data = data30, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  c30_init <- Score_DE(data = data30, CP = CP_DE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  d30_init <- Score_EE(data = data30, CP = CP_EE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  e30_init <- Score_ME(data = data30, CP1 = CP_ME1, CP2 = CP_ME2, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  b_init <- test_SA(rmst_exp = rmst_exp30[1], se_rmst_exp = rmst_exp30[2], tau = tau30, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  g30_hoch_init <- maxcombo1(data = data30, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[1]
  g30_exact_init <- maxcombo1(data = data30, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  
  data50 <- ten(S50)
  a50 <- OSLRT(data = data50, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  a502 <- mOSLRT(data = data50, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  b50 <- Score_RC(data = data50, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  c50 <- Score_DE(data = data50, CP = CP_DE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  d50 <- Score_EE(data = data50, CP = CP_EE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  e50 <- Score_ME(data = data50, CP1 = CP_ME1, CP2 = CP_ME2, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  tau50 <- max(t50)
  rmst_exp50 <- rmst_single(time = t50, status = delta50, tau = tau50)
  c <- test_SA(rmst_exp = rmst_exp50[1], se_rmst_exp = rmst_exp50[2], tau = tau50, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  g50_hoch <- maxcombo1(data = data50, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[1]
  g50_exact <- maxcombo1(data = data50, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  a50_init <- OSLRT(data = data50, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  a502_init <- mOSLRT(data = data50, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  b50_init <- Score_RC(data = data50, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  c50_init <- Score_DE(data = data50, CP = CP_DE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  d50_init <- Score_EE(data = data50, CP = CP_EE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  e50_init <- Score_ME(data = data50, CP1 = CP_ME1, CP2 = CP_ME2, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  c_init <- test_SA(rmst_exp = rmst_exp50[1], se_rmst_exp = rmst_exp50[2], tau = tau50, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  g50_hoch_init <- maxcombo1(data = data50, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[1]
  g50_exact_init <- maxcombo1(data = data50, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  
  data60 <- ten(S60)
  a60 <- OSLRT(data = data60, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  a602 <- mOSLRT(data = data60, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  b60 <- Score_RC(data = data60, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  c60 <- Score_DE(data = data60, CP = CP_DE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  d60 <- Score_EE(data = data60, CP = CP_EE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  e60 <- Score_ME(data = data60, CP1 = CP_ME1, CP2 = CP_ME2, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  tau60 <- max(t60)
  rmst_exp60 <- rmst_single(time = t60, status = delta60, tau = tau60)
  d <- test_SA(rmst_exp = rmst_exp60[1], se_rmst_exp = rmst_exp60[2], tau = tau60, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  g60_hoch <- maxcombo1(data = data60, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[1]
  g60_exact <- maxcombo1(data = data60, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  a60_init <- OSLRT(data = data60, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  a602_init <- mOSLRT(data = data60, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  b60_init <- Score_RC(data = data60, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  c60_init <- Score_DE(data = data60, CP = CP_DE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  d60_init <- Score_EE(data = data60, CP = CP_EE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  e60_init <- Score_ME(data = data60, CP1 = CP_ME1, CP2 = CP_ME2, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  d_init <- test_SA(rmst_exp = rmst_exp60[1], se_rmst_exp = rmst_exp60[2], tau = tau60, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  g60_hoch_init <- maxcombo1(data = data60, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[1]
  g60_exact_init <- maxcombo1(data = data60, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  
  data80 <- ten(S80)
  a80 <- OSLRT(data = data80, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  a802 <- mOSLRT(data = data80, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  b80 <- Score_RC(data = data80, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  c80 <- Score_DE(data = data80, CP = CP_DE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  d80 <- Score_EE(data = data80, CP = CP_EE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  e80 <- Score_ME(data = data80, CP1 = CP_ME1, CP2 = CP_ME2, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  tau80 <- max(t80)
  rmst_exp80 <- rmst_single(time = t80, status = delta80, tau = tau80)
  e <- test_SA(rmst_exp = rmst_exp80[1], se_rmst_exp = rmst_exp80[2], tau = tau80, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  g80_hoch <- maxcombo1(data = data80, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[1]
  g80_exact <- maxcombo1(data = data80, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  a80_init <- OSLRT(data = data80, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  a802_init <- mOSLRT(data = data80, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  b80_init <- Score_RC(data = data80, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  c80_init <- Score_DE(data = data80, CP = CP_DE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  d80_init <- Score_EE(data = data80, CP = CP_EE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  e80_init <- Score_ME(data = data80, CP1 = CP_ME1, CP2 = CP_ME2, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  e_init <- test_SA(rmst_exp = rmst_exp80[1], se_rmst_exp = rmst_exp80[2], tau = tau80, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  g80_hoch_init <- maxcombo1(data = data80, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[1]
  g80_exact_init <- maxcombo1(data = data80, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  
  data100 <- ten(S100)
  a100 <- OSLRT(data = data100, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  a1002 <- mOSLRT(data = data100, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  b100 <- Score_RC(data = data100, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  c100 <- Score_DE(data = data100, CP = CP_DE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  d100 <- Score_EE(data = data100, CP = CP_EE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  e100 <- Score_ME(data = data100, CP1 = CP_ME1, CP2 = CP_ME2, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  tau100 <- max(t100)
  rmst_exp100 <- rmst_single(time = t100, status = delta100, tau = tau100)
  f <- test_SA(rmst_exp = rmst_exp100[1], se_rmst_exp = rmst_exp100[2], tau = tau100, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  g100_hoch <- maxcombo1(data = data100, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[1]
  g100_exact <- maxcombo1(data = data100, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  a100_init <- OSLRT(data = data100, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  a1002_init  <- mOSLRT(data = data100, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  b100_init  <- Score_RC(data = data100, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  c100_init  <- Score_DE(data = data100, CP = CP_DE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  d100_init  <- Score_EE(data = data100, CP = CP_EE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  e100_init  <- Score_ME(data = data100, CP1 = CP_ME1, CP2 = CP_ME2, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  f_init  <- test_SA(rmst_exp = rmst_exp100[1], se_rmst_exp = rmst_exp100[2], tau = tau100, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  g100_hoch_init  <- maxcombo1(data = data100, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[1]
  g100_exact_init  <- maxcombo1(data = data100, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  
  data150 <- ten(S150)
  a150 <- OSLRT(data = data150, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  a1502 <- mOSLRT(data = data150, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  b150 <- Score_RC(data = data150, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  c150 <- Score_DE(data = data150, CP = CP_DE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  d150 <- Score_EE(data = data150, CP = CP_EE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  e150 <- Score_ME(data = data150, CP1 = CP_ME1, CP2 = CP_ME2, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  tau150 <- max(t150)
  rmst_exp150 <- rmst_single(time = t150, status = delta150, tau = tau150)
  g <- test_SA(rmst_exp = rmst_exp150[1], se_rmst_exp = rmst_exp150[2], tau = tau150, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  g150_hoch <- maxcombo1(data = data150, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[1]
  g150_exact <- maxcombo1(data = data150, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  a150_init <- OSLRT(data = data150, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  a1502_init <- mOSLRT(data = data150, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  b150_init <- Score_RC(data = data150, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  c150_init <- Score_DE(data = data150, CP = CP_DE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  d150_init <- Score_EE(data = data150, CP = CP_EE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  e150_init <- Score_ME(data = data150, CP1 = CP_ME1, CP2 = CP_ME2, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  g_init <- test_SA(rmst_exp = rmst_exp150[1], se_rmst_exp = rmst_exp150[2], tau = tau150, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  g150_hoch_init <- maxcombo1(data = data150, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[1]
  g150_exact_init <- maxcombo1(data = data150, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  
  data200 <- ten(S200)
  a200 <- OSLRT(data = data200, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  a2002 <- mOSLRT(data = data200, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  b200 <- Score_RC(data = data200, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  c200 <- Score_DE(data = data200, CP = CP_DE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  d200 <- Score_EE(data = data200, CP = CP_EE, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  e200 <- Score_ME(data = data200, CP1 = CP_ME1, CP2 = CP_ME2, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  tau200 <- max(t200)
  rmst_exp200 <- rmst_single(time = t200, status = delta200, tau = tau200)
  h <- test_SA(rmst_exp = rmst_exp200[1], se_rmst_exp = rmst_exp200[2], tau = tau200, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)
  g200_hoch <- maxcombo1(data = data200, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[1]
  g200_exact <- maxcombo1(data = data200, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_llogis = shape_llogis, scale_llogis = scale_llogis, distr = distr0)[2]
  a200_init <- OSLRT(data = data200, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  a2002_init <- mOSLRT(data = data200, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  b200_init <- Score_RC(data = data200, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  c200_init <- Score_DE(data = data200, CP = CP_DE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  d200_init <- Score_EE(data = data200, CP = CP_EE, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
  e200_init <- Score_ME(data = data200, CP1 = CP_ME1, CP2 = CP_ME2, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  h_init <- test_SA(rmst_exp = rmst_exp200[1], se_rmst_exp = rmst_exp200[2], tau = tau200, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')
  g200_hoch_init <- maxcombo1(data = data200, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[1]
  g200_exact_init <- maxcombo1(data = data200, CP1 = 1, CP2 = 3, CP3 = 3, CP4 = 5, shape_weib = shape0, scale_weib = scale0, distr = 'Weibull')[2]
...
lambda_cens <- 0.06   #15% of censoring
...
####Figure 6####
fig6 <- Diff_Eff + Diff_PH + Diff_EE + Diff_ME + Diff_DE + Diff_CH + plot_layout(guides = 'collect', ncol = 3) & theme(legend.position = 'bottom')
fig6
